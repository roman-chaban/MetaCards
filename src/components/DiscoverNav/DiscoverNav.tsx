...
export const DiscoverNav: FC<DiscoverNavProps> = ({ title, buttonLabels }) => {
  return (
    <div className={styles.discover__nav}>
      ...
      <div className={styles.nav__buttons}>
        <Button type="button" className={styles.button__primary}>
          ...
          <Image
            src="/images/exploreIcons/list.svg"
            alt="List Icon"
            width={22}
            height={22}
            className={styles.primaryButton__icon}
          />
        </Button>
        <Button type="button" className={styles.button__primary}>
          {buttonLabels.secondary}
          <Image
            src="/images/exploreIcons/collection.svg"
            alt="Collection Icon"
            width={22}
            height={22}
            className={styles.primaryButton__icon}
        ...
        <Button type="button" className={styles.button__primary}>
          ...
          <Image
            src="/images/exploreIcons/price.svg"
            alt="Price Icon"
            width={22}
            height={22}
            className={styles.primaryButton__icon}
