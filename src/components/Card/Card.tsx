...
export const Card: FC<CardProps> = ({ card, classNames }) => {
  return (
    <div className={`${styles.card} ${classNames.card}`} key={card.id}>
      ...
      <div className={styles.card__information}>
        <div className={styles.card__information_titles}>
          <p className={`${styles.card__subTitle} ${classNames.cardSubtitle}`}>
            {card.subTitle}
          </p>
          <span className={`${styles.card__rating} ${classNames.cardRating}`}>
            <Image
